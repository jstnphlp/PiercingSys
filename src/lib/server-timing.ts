...
export type ServerTimingLabel =
  ...
  | "staff.reference.assignments"
  | "staff.reference.availability"
  | "staff.reference.closures"
  | "staff.reference.services"
  | "staff.reference.stations"
  | "staff.reference.studio"
  | "staff.reference.team"
