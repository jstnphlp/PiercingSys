...
export const metricGridThree = "grid w-full grid-cols-3 gap-[15px] max-[1100px]:grid-cols-2 max-[640px]:grid-cols-1 max-[1100px]:[&>*:last-child]:col-span-2 max-[640px]:[&>*:last-child]:col-auto";
...
export const clientTablePanel = `${tablePanel} [&_table]:min-w-[850px]`;
export const operationDialog = "h-[min(740px,calc(100vh-24px))] w-[min(430px,calc(100vw-24px))] max-w-none overflow-auto rounded-[22px_16px_22px_18px] border-2 border-hippy-ink bg-[#fff5df] shadow-[8px_8px_0_#3b2923] outline-none [scrollbar-color:#d5aa89_transparent] [scrollbar-width:thin] max-[700px]:h-[calc(100vh-20px)] max-[700px]:w-[calc(100vw-20px)] max-[700px]:rounded-[18px] [&>header]:sticky [&>header]:top-0 [&>header]:z-4 [&>header]:flex [&>header]:justify-between [&>header]:gap-4 [&>header]:border-b [&>header]:border-dashed [&>header]:border-[#c88f6e] [&>header]:bg-[#fff5df] [&>header]:px-[18px] [&>header]:pt-[15px] [&>header]:pb-[11px] [&>header_h2]:m-0 [&>header_h2]:font-display [&>header_h2]:text-[21px] [&>header_h2]:leading-tight [&>header_h2]:font-bold [&>header_p]:mt-[3px] [&>header_p]:mb-0 [&>header_p]:text-[10px] [&>header_p]:leading-[1.35] [&>header_p]:text-[#785d53] [&>header_button]:grid [&>header_button]:size-[32px] [&>header_button]:shrink-0 [&>header_button]:cursor-pointer [&>header_button]:place-items-center [&>header_button]:rounded-[10px] [&>header_button]:border-[1.5px] [&>header_button]:border-hippy-ink [&>header_button]:bg-[#efc6a4] [&>header_button]:p-0 [&>header_button]:leading-none [&>header_button_svg]:block [&>header_button_svg]:size-4";
